...
<%	//System.err.println("================================= checkfwcms ============================");
	...
	/* TB_FWCMS_ONLINE_DTL request leg — one product row per UUID +
	   ...
	   is stored as the row's BTN_TRANS_REF. The row's own REFNO column is
	   the portal quotation running number (Q00001…), generated by
	   FWCMSOnline — not passed in, and never rewritten by a retry. */
