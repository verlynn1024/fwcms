...
<%	//System.err.println("================================= checkfwcms ============================");
	...
	/* TB_FWCMS_ONLINE_DTL request leg — one product row per UUID +
	   ...
	   REFNO here is the Bestinet ITR this enquiry is submitted with, and it
	   is stored as the row's ITR_NO. The row's own REFNO column is the
	   portal quotation running number (Q00001…), generated by FWCMSOnline
	   — not passed in, and never rewritten by a retry. */
...
//System.err.println("GATEWAY : "+GATEWAY);System.err.println("SEND_URL : "+SEND_URL);System.err.println("sXML : "+sXML);
	...
	/* TB_FWCMS_ONLINE / _DTL response leg (successful enquiry) — persist
	   ...
	   ITR_NO alone (printing module reads the journey and its product
