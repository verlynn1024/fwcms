...
<%
    ...
    //String SQL	= "SELECT ACCODE,ACTYPE FROM TB_ACNO WHERE USERID='"+SESUSERID+"'";
    ...
    try {
			...
			if(CLSCAT.equals("WCS")){			

    	        fileURL += "/template/pop_sub_workmenWCS_preview_08.jsp";
    	    }else if(CLSCAT.equals("FWCS")||CLSCAT.equals("FWHS")){			
    	        fileURL += "/template/pop_sub_workmenFWCS_preview_08.jsp";
    	    }else if(CLSCAT.equals("FWPS")){			

    	        fileURL += "/template/pop_sub_workmenFWPS_preview_08.jsp";
    	    }
            ...
            response.sendRedirect("pop_sub_workmen_generate_preview.jsp?CNCODE="+BATCHNO+"&CLASS=SUB&PAGE_IND="+PAGE_IND+"&EMAIL_REFNO="+EMAIL_REFNO+"&CLSCAT="+CLSCAT);                
