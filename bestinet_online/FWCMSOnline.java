...
public class FWCMSOnline extends DB_Contact{
	...
	/* =====================================================================
	   MAIN-TABLE ISSUANCE — moved out of this bean.

	   The post-payment quotation issuance (TB_TRANSACTION, TB_FWIGCN/MAST/SCH,
	   TB_FWHSCN/SCH/ITEM + the getCoverNoteFloat2 cover-note number) now lives
	   in pop_fwcms_issue_quotation.jsp, which drives the legacy DB_FWIG /
	   DB_FWHS DAOs directly. FWCMSOnline keeps only the TB_FWCMS_ONLINE*
	   tracking reads/writes the issuance JSP calls around it:
	   getFWCMSONLINETRANS / getFWCMSONLINEDTL / getFWCMSONLINEWORKERList to
	   load the journey, and updateFWCMSONLINEDTLIssued /
	   updateFWCMSONLINETRANSStatus to stamp the result back.
	   ===================================================================== */
